    ...
    waitseconds : 1000,
        packages: [
...

         {
          ...
          {
            name: 'skylark-underscore',
            location : "../node_modules/skylark-underscore/dist/uncompressed/skylark-underscore",
            main: 'main'
          },

          {
            name: 'skylark-data-entities',
            location : "../node_modules/skylark-data-entities/dist/uncompressed/skylark-data-entities",
            main: 'main'
          },          
          {
            name: 'skylark-backbone',
            location : "../node_modules/skylark-backbone/dist/uncompressed/skylark-backbone",
            main: 'main'
          },          
          {
...
//           location : "../../skylark-widgets-base/src",
          ...
          {
            name: 'skylark-threejs-extra',
            location : "../packages/skylark-threejs-extra/src",
            main: 'main'
          },
...
require(["skylark-jquery"], function ($) {
    require(["skylark-grapejs"], function (grapejs) {
        if (window.initPage) {
            window.initPage($,grapejs);
        }
    });
});